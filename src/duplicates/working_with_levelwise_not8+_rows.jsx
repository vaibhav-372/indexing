// working fine after level changed but after 8 rows next row not adding 
    ...
    axios
      ...
      .then((res) => {
        if (res.data && res.data[boxKey]?.[`level${level}`]) {
          ...
          // ✅ Only update future rows (from currentRow onwards)
          setBoxStates((prev) => {
            ...
            return {
              ...
              [boxKey]: {
                ...
                dataIndex: 0, // reset index for new level
              },
            };
          });
        }
